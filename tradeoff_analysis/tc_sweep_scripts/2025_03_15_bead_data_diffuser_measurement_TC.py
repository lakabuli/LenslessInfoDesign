...
# Script for computing Tamura Coefficient (TC) on bead measurement datasets with diffuser PSF
# patterns and various aperture sizes. Computes Tamura coefficients for full images, noisy
# images, patches, and noisy patches.
...
psf_patterns = [aperture_psf_2, aperture_psf_8, aperture_psf_10, aperture_psf_12, aperture_psf_14, aperture_psf, diffuser_psf]
psf_names = ['aperture_2', 'aperture_8', 'aperture_10', 'aperture_12', 'aperture_14', 'aperture', 'diffuser']
