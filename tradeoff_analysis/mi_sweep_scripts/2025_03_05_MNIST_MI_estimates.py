...
# Script for estimating Mutual Information (MI) on MNIST dataset
...
save_dir = '/home/lakabuli/workspace/LenslessInfoDesign/tradeoff_analysis/mi_estimates/mnist_mi_estimates/'
