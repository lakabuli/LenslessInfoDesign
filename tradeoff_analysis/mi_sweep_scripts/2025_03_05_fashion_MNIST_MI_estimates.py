...
# Script for estimating Mutual Information (MI) on Fashion MNIST dataset
...
save_dir = '/home/lakabuli/workspace/LenslessInfoDesign/tradeoff_analysis/mi_estimates/fashion_mnist_mi_estimates/'
    ...
    for psf_index, psf_pattern in enumerate(psf_patterns):
        ...
        for seed_value in seed_values_full:
            if dataset_name == 'fashion_mnist':
                ...
                print("Invalid dataset name. Please use 'mnist' or 'fashion_mnist' or 'cifar10'")
                break
            ...
            # zero pad images to be 32 x 32 size 
