...
# Notebook for seed sweep experiments with random initialization for Supplement Sec. S5.1

# Optimize lensless imaging systems on MNIST with different random seeds
# Uses random initialization for lenslet positions
# The stock initialization is 100 photon count, 25 gaussians, patch size 16, 4096 patches, 2000 steps. 
# Learning rates are 5e-3, 1e-3, and 1e-4 respectively for means, covariances, and weights.
import os
import sys
...
for seed_value in [42, 16, 79, 200, 876, 123, 1111]: 
    # general parameters 
    ...
    run_name='{}_diagonal_cov_sigma_08_random_init_{}_lenslets_{}_patches_5e-3_mean_1e-4_weight_lr_clean_images_seed_{}'.format( 
