...
# Notebook for Fig. 3 and Fig. S8

# Three datasets: MNIST, Fashion MNIST, and CIFAR10
# In each case, initialize with the same random 25 lenslet configuration and optimize from there
...
for dataset_name in ['mnist', 'fashion_mnist', 'cifar10']:
    ...
    run_name='{}_diagonal_cov_sigma_08_random_init_{}_lenslets_{}_patches_3e-2_mean_1e-4_weight_lr_clean_images_seed_{}'.format( 
