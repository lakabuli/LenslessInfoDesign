...
# Notebook for optimizing encoders for bead datasets with random initialization for Fig. 3 and Fig. S8.
...
bead_sparsity_factors = [0.02]

for bead_sparsity_factor in bead_sparsity_factors:
    # general parameters 
    seed_value = 42
    ...
    run_name='{}_{}_sparsity_diagonal_cov_sigma_08_random_init_{}_lenslets_{}_patches_3e-2_mean_1e-4_weight_lr_clean_images_seed_{}'.format( 
