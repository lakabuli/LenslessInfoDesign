...
# Script for running reconstruction sweeps on uniform lenslet PSFs (one through nine).
...
psf_list = [one_psf, two_psf, three_psf, four_psf, five_psf, six_psf, seven_psf, eight_psf, nine_psf]
